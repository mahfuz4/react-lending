  ...
  return (
    <section className="py-28 bg-gray-900 text-white sm-css md:md-css ">
      <div className="text-center w-full lg:w-8/12 mx-auto mb-14">
        <button className="uppercase text-green-600 text-xs px-2 py-1 rounded bg-green-300 font-semibold">
          message us
        </button>
      ...
      <div className=" w-full lg:w-6/12 mx-auto text-gray-600 bg-blue-50 shadow-sm p-10 rounded ">
        ...
        <label className="uppercase tracking-wider leading-relaxed text-xs font-bold ">
          full name
        </label>
        <input
        ...
        <div className="text-center">
          <button className="mt-6 text-xs px-4 py-2 shadow hover:shadow-md  bg-gray-800 border-gray-800 active:bg-gray-900 active:border-blueGray-900 rounded outline-none focus:outline-none align-middle transition-all duration-150 ease-in-out uppercase border border-solid font-bold text-white">
            send message
          </button>
        </div>
      </div>
